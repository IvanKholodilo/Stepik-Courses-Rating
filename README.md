...
Обе таблицы содеждат одни и те же данные. В stepik.csv сортировка произведена по произведению оценки и количества отзывов, а в stepik_short.csv просто по оценке. Так же stepik_short.csv содержит меньше данных о курсах.
##
