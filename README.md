...
Обе таблицы содержат одни и те же данные. В stepik.csv сортировка произведена по произведению оценки и количества отзывов, а в stepik_short.csv по оценке умноженной на 100, если отзывов больше 20 и на 1, если меньше. Так же stepik_short.csv содержит меньше данных о курсах.
